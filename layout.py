# Form implementation generated from reading ui file '.\AppLayout_splitter_stackedWidget.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.widget = QtWidgets.QWidget(parent=self.AllocationPage)
        self.widget.setGeometry(QtCore.QRect(10, 10, 454, 80))
        self.widget.setObjectName("widget")
        self.gridLayout_4 = QtWidgets.QGridLayout(self.widget)
        self.gridLayout_4.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_4.setObjectName("gridLayout_4")
        self.lblAllocAmount = QtWidgets.QLabel(parent=self.widget)
        self.lblAllocAmount.setObjectName("lblAllocAmount")
        self.gridLayout_4.addWidget(self.lblAllocAmount, 0, 0, 1, 1)
        self.edtAllocAmount = QtWidgets.QLineEdit(parent=self.widget)
        self.edtAllocAmount.setObjectName("edtAllocAmount")
        self.gridLayout_4.addWidget(self.edtAllocAmount, 0, 1, 1, 1)
        self.lbl_pctpf = QtWidgets.QLabel(parent=self.widget)
        self.lbl_pctpf.setObjectName("lbl_pctpf")
        self.gridLayout_4.addWidget(self.lbl_pctpf, 0, 2, 1, 1)
        self.edt_pct_of_portfolio = QtWidgets.QLineEdit(parent=self.widget)
        ...
        self.cmbToSector = QtWidgets.QComboBox(parent=self.widget)
