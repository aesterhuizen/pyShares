...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.edtFileBrowse = QtWidgets.QLineEdit(parent=self.BuySellExceptPage)
        self.edtFileBrowse.setGeometry(QtCore.QRect(154, 40, 171, 22))
        self.edtFileBrowse.setObjectName("edtFileBrowse")
        self.btnBrowse = QtWidgets.QPushButton(parent=self.BuySellExceptPage)
        self.btnBrowse.setGeometry(QtCore.QRect(330, 40, 75, 24))
        self.btnBrowse.setObjectName("btnBrowse")
        self.label = QtWidgets.QLabel(parent=self.BuySellExceptPage)
        self.label.setGeometry(QtCore.QRect(9, 39, 105, 16))
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(parent=self.BuySellExceptPage)
        self.label_2.setGeometry(QtCore.QRect(9, 10, 139, 16))
        self.label_2.setObjectName("label_2")
        self.edtLstStocksSellected = QtWidgets.QLineEdit(parent=self.BuySellExceptPage)
        self.edtLstStocksSellected.setGeometry(QtCore.QRect(154, 10, 171, 22))
        self.edtLstStocksSellected.setObjectName("edtLstStocksSellected")
        self.label_3 = QtWidgets.QLabel(parent=self.BuySellExceptPage)
        self.label_3.setGeometry(QtCore.QRect(9, 70, 109, 16))
        self.label_3.setObjectName("label_3")
        self.edtAmountEst = QtWidgets.QLineEdit(parent=self.BuySellExceptPage)
        self.edtAmountEst.setGeometry(QtCore.QRect(154, 70, 91, 22))
