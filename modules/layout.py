...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.widget = QtWidgets.QWidget(parent=self.ActionsPage)
        self.widget.setGeometry(QtCore.QRect(9, 20, 528, 24))
        self.widget.setObjectName("widget")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.widget)
        self.horizontalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.lblRaiseAmount = QtWidgets.QLabel(parent=self.widget)
        self.lblRaiseAmount.setObjectName("lblRaiseAmount")
        self.horizontalLayout_2.addWidget(self.lblRaiseAmount)
        self.edtRaiseAmount = QtWidgets.QLineEdit(parent=self.widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.lblbuyWith = QtWidgets.QLabel(parent=self.widget)
        self.lblbuyWith.setObjectName("lblbuyWith")
        self.horizontalLayout_2.addWidget(self.lblbuyWith)
        self.edtBuyWith = QtWidgets.QLineEdit(parent=self.widget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.widget1 = QtWidgets.QWidget(parent=self.ActionsPage)
        self.widget1.setGeometry(QtCore.QRect(10, 51, 491, 24))
        self.widget1.setObjectName("widget1")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout(self.widget1)
        self.horizontalLayout_3.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.lblBuyWithAmount = QtWidgets.QLabel(parent=self.widget1)
        self.lblBuyWithAmount.setObjectName("lblBuyWithAmount")
        self.horizontalLayout_3.addWidget(self.lblBuyWithAmount)
        self.edtBuyWithAmount = QtWidgets.QLineEdit(parent=self.widget1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.widget2 = QtWidgets.QWidget(parent=self.ActionsPage)
        self.widget2.setGeometry(QtCore.QRect(10, 81, 539, 24))
        self.widget2.setObjectName("widget2")
        self.horizontalLayout_4 = QtWidgets.QHBoxLayout(self.widget2)
        self.horizontalLayout_4.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_4.setObjectName("horizontalLayout_4")
        self.lblDollarValueToSell = QtWidgets.QLabel(parent=self.widget2)
        self.lblDollarValueToSell.setObjectName("lblDollarValueToSell")
        self.horizontalLayout_4.addWidget(self.lblDollarValueToSell)
        self.edtDollarValueToSell = QtWidgets.QLineEdit(parent=self.widget2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.cmbDollarShare = QtWidgets.QComboBox(parent=self.widget2)
        ...
        self.layoutWidget2 = QtWidgets.QWidget(parent=self.buyLowerPage)
        self.layoutWidget2.setGeometry(QtCore.QRect(9, 20, 579, 50))
        ...
        self.cmbReInvest = QtWidgets.QComboBox(parent=self.layoutWidget2)
        ...
        self.edtReinvestAmount = QtWidgets.QLineEdit(parent=self.layoutWidget2)
        ...
        self.edtStocksInFile_Reinvest = QtWidgets.QLineEdit(parent=self.layoutWidget2)
        ...
        self.lblbuylower = QtWidgets.QLabel(parent=self.layoutWidget2)
        self.lblbuylower.setObjectName("lblbuylower")
        self.gridLayout_6.addWidget(self.lblbuylower, 1, 0, 1, 2)
        self.edtFileBrowse_Reinvest = QtWidgets.QLineEdit(parent=self.layoutWidget2)
        ...
        self.btnBrowseReInvest = QtWidgets.QPushButton(parent=self.layoutWidget2)
        ...
        self.edtReInvestValue = QtWidgets.QLineEdit(parent=self.layoutWidget2)
