...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        spacerItem = QtWidgets.QSpacerItem(20, 55, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        ...
        self.layoutWidget1 = QtWidgets.QWidget(parent=self.BuySellExceptPage)
        self.layoutWidget1.setGeometry(QtCore.QRect(9, 23, 343, 82))
        self.layoutWidget1.setObjectName("layoutWidget1")
        self.gridLayout_7 = QtWidgets.QGridLayout(self.layoutWidget1)
        self.gridLayout_7.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_7.setObjectName("gridLayout_7")
        self.lblSellAssetExSel = QtWidgets.QLabel(parent=self.layoutWidget1)
        self.lblSellAssetExSel.setObjectName("lblSellAssetExSel")
        self.gridLayout_7.addWidget(self.lblSellAssetExSel, 0, 0, 1, 1)
        self.edtLstStocksSelected = QtWidgets.QLineEdit(parent=self.layoutWidget1)
        self.edtLstStocksSelected.setObjectName("edtLstStocksSelected")
        self.gridLayout_7.addWidget(self.edtLstStocksSelected, 0, 1, 1, 1)
        self.lblExceptStocks_in_file = QtWidgets.QLabel(parent=self.layoutWidget1)
        self.lblExceptStocks_in_file.setObjectName("lblExceptStocks_in_file")
        self.gridLayout_7.addWidget(self.lblExceptStocks_in_file, 1, 0, 1, 1)
        self.edtFileBrowse = QtWidgets.QLineEdit(parent=self.layoutWidget1)
        self.edtFileBrowse.setObjectName("edtFileBrowse")
        self.gridLayout_7.addWidget(self.edtFileBrowse, 1, 1, 1, 1)
        self.btnBrowse = QtWidgets.QPushButton(parent=self.layoutWidget1)
        ...
        self.edtAmountEst = QtWidgets.QLineEdit(parent=self.layoutWidget1)
        ...
        self.layoutWidget2 = QtWidgets.QWidget(parent=self.ActionsPage)
        self.layoutWidget2.setGeometry(QtCore.QRect(9, 20, 528, 24))
        self.layoutWidget2.setObjectName("layoutWidget2")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.layoutWidget2)
        self.horizontalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.lblRaiseAmount = QtWidgets.QLabel(parent=self.layoutWidget2)
        self.lblRaiseAmount.setObjectName("lblRaiseAmount")
        self.horizontalLayout_2.addWidget(self.lblRaiseAmount)
        self.edtRaiseAmount = QtWidgets.QLineEdit(parent=self.layoutWidget2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.lblbuyWith = QtWidgets.QLabel(parent=self.layoutWidget2)
        self.lblbuyWith.setObjectName("lblbuyWith")
        self.horizontalLayout_2.addWidget(self.lblbuyWith)
        self.edtBuyWith = QtWidgets.QLineEdit(parent=self.layoutWidget2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.layoutWidget3 = QtWidgets.QWidget(parent=self.ActionsPage)
        self.layoutWidget3.setGeometry(QtCore.QRect(10, 51, 491, 24))
        self.layoutWidget3.setObjectName("layoutWidget3")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout(self.layoutWidget3)
        self.horizontalLayout_3.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.lblBuyWithAmount = QtWidgets.QLabel(parent=self.layoutWidget3)
        self.lblBuyWithAmount.setObjectName("lblBuyWithAmount")
        self.horizontalLayout_3.addWidget(self.lblBuyWithAmount)
        self.edtBuyWithAmount = QtWidgets.QLineEdit(parent=self.layoutWidget3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.layoutWidget4 = QtWidgets.QWidget(parent=self.ActionsPage)
        self.layoutWidget4.setGeometry(QtCore.QRect(10, 81, 539, 24))
        self.layoutWidget4.setObjectName("layoutWidget4")
        self.horizontalLayout_4 = QtWidgets.QHBoxLayout(self.layoutWidget4)
        self.horizontalLayout_4.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_4.setObjectName("horizontalLayout_4")
        self.lblDollarValueToSell = QtWidgets.QLabel(parent=self.layoutWidget4)
        self.lblDollarValueToSell.setObjectName("lblDollarValueToSell")
        self.horizontalLayout_4.addWidget(self.lblDollarValueToSell)
        self.edtDollarValueToSell = QtWidgets.QLineEdit(parent=self.layoutWidget4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.cmbDollarShare = QtWidgets.QComboBox(parent=self.layoutWidget4)
        ...
        self.layoutWidget5 = QtWidgets.QWidget(parent=self.buyLowerPage)
        self.layoutWidget5.setGeometry(QtCore.QRect(9, 20, 579, 54))
        self.layoutWidget5.setObjectName("layoutWidget5")
        self.gridLayout_6 = QtWidgets.QGridLayout(self.layoutWidget5)
        self.gridLayout_6.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_6.setObjectName("gridLayout_6")
        self.label_8 = QtWidgets.QLabel(parent=self.layoutWidget5)
        self.label_8.setObjectName("label_8")
        self.gridLayout_6.addWidget(self.label_8, 0, 0, 1, 1)
        self.cmbReInvest = QtWidgets.QComboBox(parent=self.layoutWidget5)
        ...
        self.edtReinvestAmount = QtWidgets.QLineEdit(parent=self.layoutWidget5)
        self.edtReinvestAmount.setObjectName("edtReinvestAmount")
        ...
        self.edtStocksInFile_Reinvest = QtWidgets.QLineEdit(parent=self.layoutWidget5)
        self.edtStocksInFile_Reinvest.setObjectName("edtStocksInFile_Reinvest")
        self.gridLayout_6.addWidget(self.edtStocksInFile_Reinvest, 0, 9, 1, 1)
        self.lblbuylower = QtWidgets.QLabel(parent=self.layoutWidget5)
        self.lblbuylower.setObjectName("lblbuylower")
        self.gridLayout_6.addWidget(self.lblbuylower, 1, 0, 1, 2)
        self.edtFileBrowse_Reinvest = QtWidgets.QLineEdit(parent=self.layoutWidget5)
        self.edtFileBrowse_Reinvest.setObjectName("edtFileBrowse_Reinvest")
        self.gridLayout_6.addWidget(self.edtFileBrowse_Reinvest, 1, 2, 1, 3)
        self.btnBrowseReInvest = QtWidgets.QPushButton(parent=self.layoutWidget5)
        ...
        self.edtReInvestValue = QtWidgets.QLineEdit(parent=self.layoutWidget5)
        ...
        self.gridLayout_3 = QtWidgets.QGridLayout(self.StockGraphInfoPage)
        self.gridLayout_3.setObjectName("gridLayout_3")
        self.tabStock_Info = QtWidgets.QTabWidget(parent=self.StockGraphInfoPage)
        self.tabStock_Info.setObjectName("tabStock_Info")
        self.tabGraphType = QtWidgets.QWidget()
        self.tabGraphType.setObjectName("tabGraphType")
        self.layoutWidget_2 = QtWidgets.QWidget(parent=self.tabGraphType)
        self.layoutWidget_2.setGeometry(QtCore.QRect(10, 10, 231, 24))
        ...
        self.cmbGraphType = QtWidgets.QComboBox(parent=self.layoutWidget_2)
        ...
        self.tabSectorAnalysis = QtWidgets.QWidget()
        self.tabSectorAnalysis.setObjectName("tabSectorAnalysis")
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.tabSectorAnalysis)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.tblSectorAnalytics = QtWidgets.QTableWidget(parent=self.tabSectorAnalysis)
        self.tblSectorAnalytics.setShowGrid(False)
        self.tblSectorAnalytics.setObjectName("tblSectorAnalytics")
        self.tblSectorAnalytics.setColumnCount(0)
        self.tblSectorAnalytics.setRowCount(0)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/res/exit.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lblSellAssetExSel.setText(_translate("MainWindow", "Sell Asset Except sellected:"))
        self.lblExceptStocks_in_file.setText(_translate("MainWindow", "Except stocks in file:"))
        ...
        self.label_5.setText(_translate("MainWindow", "of Amount (USD):"))
        self.label_7.setText(_translate("MainWindow", "in selected stocks:"))
        self.lblbuylower.setText(_translate("MainWindow", "Or Stocks in file:"))
        self.btnBrowseReInvest.setText(_translate("MainWindow", "Browse ..."))
        self.label_6.setText(_translate("MainWindow", "Reinvest Value:"))
        self.label_4.setText(_translate("MainWindow", "Graph Type:"))
        self.tabStock_Info.setTabText(self.tabStock_Info.indexOf(self.tabGraphType), _translate("MainWindow", "Graph Type"))
        self.tabStock_Info.setTabText(self.tabStock_Info.indexOf(self.tabSectorAnalysis), _translate("MainWindow", "Sector Analytics"))
